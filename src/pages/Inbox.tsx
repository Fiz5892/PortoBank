      ...
      <section className="container py-6 md:py-8">
        <div className="mx-auto max-w-7xl space-y-6">
          ...
          <div className="grid gap-4 lg:grid-cols-[360px_1fr]">
            ...
            <Card
              className={cn(
                "p-2 shadow-subtle max-h-[calc(100vh-220px)] min-h-[560px] overflow-y-auto",
                activePartnerId && "hidden lg:block"
              )}
            >
            ...
            <Card
              className={cn(
                "shadow-subtle flex flex-col h-[calc(100vh-220px)] min-h-[560px]",
